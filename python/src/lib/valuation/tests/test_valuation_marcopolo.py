...
from .fixture_test_valuation_marcopolo import FixtureValuationMarcopolo2009T12021T4


class TestValuationMarcopolo(FixtureValuationMarcopolo2009T12021T4):
    print_to_stdout = True

    def setUp(self):
        self.valuation = TestValuationMarcopolo.valuation
    ...
    def test_get_indices_liquidez(self):
        ...
        if TestValuationMarcopolo.print_to_stdout:
