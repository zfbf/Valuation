...
from ..seca import IndiceLiquidezSecaReporter
...
class TestIndiceLiquidezSecaReporter(unittest.TestCase):
    ...
    def setUp(self):
        self.valuation_base = TestIndiceLiquidezSecaReporter.valuation_base
        self.valuation_outros = TestIndiceLiquidezSecaReporter.valuation_outros

    def tearDown(self):
        self.valuation_base = None

    def test_execute(self):
        reporter = IndiceLiquidezSecaReporter(self.valuation_base)
