...
from ..dados_2009T1_2022T1 import Iochpe2009T12022T1
...
class TestIochpeDadosTrimestraisAnualizados(unittest.TestCase):
    ...
    def setUp(self):
        self.iochpe_dta = Iochpe2009T12022T1()
    ...
    def test_get_identificador(self):
        ...
        self.assertEqual(identificador, 'Iochpe_2009T1_2022T1')
    ...
    def test_get_dados_empresa_file_name(self):
        ...
        self.assertEqual(iochpe_dados_file_name,
                'economatica_Iochpe_2009T1-2022T1.xls')
