...
from ..dados_2009T1_2022T1 import Embraer2009T12022T1
...
class TestEmbraerDadosTrimestraisAnualizados(unittest.TestCase):
    ...
    def setUp(self):
        self.embraer_dta = Embraer2009T12022T1()
    ...
    def test_get_identificador(self):
        ...
        self.assertEqual(identificador, 'Embraer_2009T1_2022T1')
    ...
    def test_get_dados_empresa_file_name(self):
        ...
        self.assertEqual(embraer_dados_file_name,
                'economatica_Embraer_2009T1-2022T1.xls')
