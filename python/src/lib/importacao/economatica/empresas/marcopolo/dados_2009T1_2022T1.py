...
class Marcopolo2009T12022T1(EconomaticaDadosTrimestraisAnualizados):
    def __init__(self):
        super().__init__('Marcopolo', 'POMO3', 2009, 1, 2022, 1)

    def get_dados_empresa_file_path(self):
        relative_path = 'economatica/marcopolo/'
        return os.path.join(super().get_dados_dir(), relative_path)

    def get_dados_empresa_file_name(self):
        return 'economatica_Marcopolo_2009T1-2022T1.xls'
