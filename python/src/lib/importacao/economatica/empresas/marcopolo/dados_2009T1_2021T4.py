...
class Marcopolo2009T12021T4(EconomaticaDadosTrimestraisAnualizados):
    def __init__(self):
        super().__init__('Marcopolo', 'POMO3', 2009, 1, 2021, 4)
    ...
    def get_dados_empresa_file_name(self):
        return 'economatica_Marcopolo_2009T1-2021T4.xls'
