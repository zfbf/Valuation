...
class TestPassivoCirculanteDefaultLoader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.passivo_circulante_2010 = periodos[1]['bp'].passivo.circulante
        self.passivo_circulante_loader = PassivoCirculanteDefaultLoader()
